...
2. **Use ranges publicly, fixed quotes privately** — the website and marketing materials should show indicative ranges; the actual quote is confirmed after the 15-minute Security Conversation or a scoping call.
...
- **Public on the website**: "from" ranges for every paid service, and "free" for the Health Check. This is a deliberate transparency choice, not the market norm for consulting, and is one of the differentiators worth stating plainly (see Fractional Wisdom benchmark note in `00-business/decisions.md`).
- **Confirmed privately**: the specific fixed quote, after the 15-minute Security Conversation or a short scoping exchange, once business size and complexity are known.
