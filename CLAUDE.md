...
The complete operating system for Pharos Security, an independent cyber security advisory practice for New Zealand SMEs, founded by Oscar. It contains business strategy, the service catalogue, an operating manual, client templates, sales and marketing material, AI agent specifications, and the live website. See `00_README_START_HERE.md` for the full map, and `09-project-management/current-state-review.md` for the current reconciliation status between the original studio structure and the Master Build Directive.
...
6. **Every client-facing conclusion requires Oscar's review and approval before it reaches a client.** AI-assisted drafts are drafts. Say so explicitly when producing one.
...
8. **Do not start active technical testing, contact a client, commit Pharos to pricing or scope, or issue a final report without Oscar's explicit approval.**
