...
*Used per [../04_Operating_Manual/proposal-process.md](../04_Operating_Manual/proposal-process.md) and [../04_Operating_Manual/client-intake-process.md](../04_Operating_Manual/client-intake-process.md).*

---

## 1. Enquiry acknowledgement (same/next business day)

**Subject:** Re: [their subject line, or "Thanks for reaching out"]
...
## 4. Post-engagement feedback request

**Subject:** How did we do?

Hi [First Name],

Now that [service/deliverable] is wrapped up, I'd really value a few honest thoughts:
...
## 5. Six-month soft re-engagement (for "not proceeding" or completed clients)
